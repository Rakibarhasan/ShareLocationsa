...
public class Check_netConnection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_net_connection);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Check_netConnection.this,ExtraPage.class);
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            // location last updated time
            txtUpdatedOn.setText("Running all device GPS: " + mLastUpdateTime);
        }
        ...
        mSettingsClient
                ...
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        Alerter.create(Check_netConnection.this)
                                .setTitle("Please Wait")
                                .setText("Run Device")
                                .setIcon(R.drawable.ic_add_alert_black_24dp)
                                .setBackgroundColor(R.color.slide_3)
                                .show();
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Check_netConnection.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Check_netConnection.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
